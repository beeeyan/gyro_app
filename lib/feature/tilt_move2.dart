...
class TrialTiltMovePage extends StatefulWidget {
  const TrialTiltMovePage({super.key});

  static const String name = 'trial_tiltmove';
  static const String path = '/trial_tiltmove';

  @override
  State<TrialTiltMovePage> createState() => _TrialTiltMovePageState();
}

class _TrialTiltMovePageState extends State<TrialTiltMovePage>
